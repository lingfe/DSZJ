// pages/myDrippingWater/dripInvitation/dirpInvitationAdd/dirpInvitationAdd.js
var app=getApp();
Page({
  ...
  reqSetData: function (e,pictures){
    //请求
    wx.request({
      url: app.config.dszjPath_web + 'api/UserInvitation/add',
      method: "POST",
      header: {
        Token: wx.getStorageSync('token')
      },
